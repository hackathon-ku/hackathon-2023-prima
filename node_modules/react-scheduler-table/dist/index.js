	...
	createClass(Timetable, [{
		...
		value: function renderTimeCell(time) {
			...
			var _loop = function _loop(column) {
				arr.push(React__default.createElement(
					"td",
					{
						"data-test": "TimeCell",
					...
					React__default.createElement(
						...
						cellReservedStatus(column) === "reserved-start" ? React__default.createElement(ReservedTime, {
						...
						cellStatus(column) === "start" ? React__default.createElement(
							"div",
							null,
							React__default.createElement(
								"button",
						...
						cellStatus(column) === "end" ? React__default.createElement(
							"button",
							{
						...
						shouldAddButtonRendered(time, column) ? React__default.createElement("button", {
		...
		value: function renderTimeRow() {
			...
			for (var i = startDay; i < endDay; i += hourSplit) {
				var el = React__default.createElement(
					"tr",
					{ key: i },
					React__default.createElement(
						"td",
